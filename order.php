...
if (isset($_GET['id'])) {
  ...
  $_SESSION["pizza-id"] = $pizza['ID'];
  $_SESSION['title'] = $pizza['title'];
  $_SESSION['ingridients'] = $pizza['Ingredients'];
}
...
if (isset($_POST['submit'])) {
  ...
  if (array_filter($errors)) {
    ...
    $pizzaId = $_SESSION['pizza-id'];

    //Insert order into Db
    $sql = "INSERT INTO orders(name, email, address, pizza) VALUES('$name', '$email', '$address', '$pizzaId')";
    if (mysqli_query($conn, $sql)) {
      //data inserted

      //Sent mail to customer
      //configure mail Sender using PHPMailer
      ...
      try {
        ...
        $mail->Port = '465';
        $mail->isHTML();
        $mail->Username = 'freepizza4all@gmail.com';
        $mail->Password = 'CHr16091997';
        $mail->setFrom('freepizza4all@gmail.com', "FreePizza4All");
        $mail->Subject = "Your Free Pizza Order";
                ...
                <!--<![endif]-->
                    <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #fbfbfb;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
                      ...
                      <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                        <h1 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #565656;font-size: 22px;line-height: 31px;font-family: Avenir,sans-serif;">FreePizza4All</h1><p style="Margin-top: 20px;Margin-bottom: 0;">Thank you for your order.</p><p style="Margin-top: 20px;Margin-bottom: 0;"><strong>Pizza Info</strong></p><p style="Margin-top: 20px;Margin-bottom: 0;">&nbsp;Name: ' . $name . '</p><p style="Margin-top: 20px;Margin-bottom: 0;">Address: ' . $address . '</p><p style="Margin-top: 20px;Margin-bottom: 0;">Pizza: ' . $_SESSION['title'] . '</p><p style="Margin-top: 20px;Margin-bottom: 0;">Ingridients: ' . $_SESSION['ingridients'] . '</p>
                      </div>
                    </div>
                            ...
                            <div class="column wide" style="text-align: left;font-size: 12px;line-height: 19px;color: #999;font-family: Georgia,serif;Float: left;max-width: 400px;min-width: 320px; width: 320px;width: calc(8000% - 47600px);">
                              <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
                                ...
                                <div style="font-size: 12px;line-height: 19px;">
                                  <div>FreePizza4All<br />
                University of Thessaly</div>
                                </div>
      ...
      //redirect to (thank customer) page.
      header('location: order-after.php');
    } else {
    ...
    <section class="container gray-text">
      <div class="row">
        <form class="col s12" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
          ...
          <div class="center">
            <button class="btn brand waves-effect waves-light" type="submit" name="submit">Send Order
